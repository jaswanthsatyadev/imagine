...
android {
    ...
    namespace = "com.evolvarc.imagine"

    defaultConfig {
        vectorDrawables.useSupportLibrary = true

        //Maintained for compatibility with old version
        applicationId = "com.evolvarc.imagine"
        ...
        setProperty("archivesBaseName", "imagine-$versionName${if (isFoss) "-foss" else ""}")
    }
    ...
    buildTypes {
        debug {
            ...
            resValue("string", "app_launcher_name", "Imagine DEBUG")
            resValue("string", "file_provider", "com.evolvarc.imagine.fileprovider.debug")
        }
        release {
            ...
            resValue("string", "app_launcher_name", "Imagine")
            resValue("string", "file_provider", "com.evolvarc.imagine.fileprovider")
        }
        create("benchmark") {
