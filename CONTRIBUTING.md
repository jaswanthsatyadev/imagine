...
- Fork this repository "Imagine" by clicking on the "Fork" button. This will create a local copy of this respository on your GitHub profile.
...
```bash  
cd Imagine  
git remote add upstream https://github.com/jaswanthsatyadev/Imagine.git
