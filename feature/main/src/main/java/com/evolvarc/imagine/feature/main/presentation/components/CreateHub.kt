    ...
    LazyVerticalStaggeredGrid(
        ...
        item(span = StaggeredGridItemSpan.FullLine) {
            Box(
                ...
                HeroCard(
                    onClick = { onNavigate(Screen.CollageMaker()) }
                )
            }
        }
        ...
        val filteredList = screenList.filter {
            it !is Screen.CollageMaker &&
            it !is Screen.Draw &&
            it !is Screen.GradientMaker &&
            it !is Screen.Watermarking
        }
    ...
    Box(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    text = stringResource(R.string.collage_maker_sub),
                    style = MaterialTheme.typography.bodyLarge,
                    color = MaterialTheme.colorScheme.onSecondaryContainer.copy(alpha = 0.8f)
                )
            }
            Icon(
                imageVector = Icons.Outlined.Collage,
    ...
    Column(modifier = Modifier.padding(vertical = 8.dp)) {
        ...
        Row(
            ...
            QuickActionItem(
                ...
                onClick = { onNavigate(Screen.Draw()) },
                modifier = Modifier.weight(1f)
            )
            QuickActionItem(
                title = "Gradient",
                icon = Icons.Outlined.Gradient,
                onClick = { onNavigate(Screen.GradientMaker()) },
                modifier = Modifier.weight(1f)
            )
            QuickActionItem(
                title = "Watermark",
                icon = Icons.AutoMirrored.Outlined.BrandingWatermark,
                onClick = { onNavigate(Screen.Watermarking()) },
                modifier = Modifier.weight(1f)
            )
        }
    }
